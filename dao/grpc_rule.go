...
type GrpcRule struct {
	...
	HeaderTransfer string `json:"header_transfer" gorm:"column:header_transfor" description:"header转换支持增加(add)、删除(del)、修改(edit) 格式: add headname headvalue"`
}
...
func (t *GrpcRule) ListByServiceID(c *gin.Context, tx *gorm.DB, serviceID int64) (list []GrpcRule, count int64, err error) {
